...
const IdPost: React.FC<IndexProps> = (props) => {
  ...
  const handleDeleteCmt = async () => {
    try {
      ...
      alert(`This post is not about you !`);
    }
  };
    ...
    <div className="dark:text-black">
      {loading ? (
        <div>
          <img
            className="m-auto"
            src="https://media1.tenor.co/images/337e45c198a137d98c5b38871e61d026/tenor.gif?itemid=8985245"
          />
        </div>
      ) : (
        <div className="flex p-8 bg-red-200 bg-opacity-70">
          ...
          <IconLeft className="hidden sm:block" />
            ...
            <div className="p-4 bg-purple-400 rounded-lg shadow-md bg-opacity-20 my-7 sm:p-12">
              <div className="relative block m-auto bg-white rounded-md shadow-lg my-7 p-14">
                <img
                  ...
                  src={`https://create-minifb.herokuapp.com/avatar/${post?.user.avatar}`}
                />

                <p className="absolute w-2/12 truncate text-sm font-bold sm:top-2 sm:left-20 sm:text-xl top-3 left-20">
                  {post?.user.fullname}
                </p>
                <p className="absolute text-sm sm:top-8 sm:left-20 top-7 left-20">
                        ...
                        return (
                          <div key={item._id} className="flex mt-6">
                            <img
                              ...
                              src={`https://create-minifb.herokuapp.com/avatar/${item.authorId.avatar}`}
                            />
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                  ...
                                  <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                      If you agree, this post will be deleted
                                      and no longer exist on the homepage
                                    </p>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                          ...
                          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div className="mt-2">
                              <p className="text-sm text-gray-500">
                                If you agree, this comment will be deleted and
